...
- 🎓 Incoming Information Systems student in **Saint Petersburg, Russia**  
- 🔐 Transitioning to the field of **Cybersecurity**  
- 💬 I love learning new things, solving problems, and building cool stuff  
- 🛹 Off-duty? I'm either skating or playing basketball
...
- PC and smartphone maintenance
- Basic Linux
- Learning ethical hacking (Burp Suite, Kali Linux)

**Programming & Data**
- Python scripting
- Power BI (data dashboards)
- Advanced Excel
- Basic automation and custom tools (e.g. port scanner)

**Web & E-commerce**
- Experience with online stores and digital marketing
- Basic HTML and SEO
...
> Studying ethical hacking, data protection, system defense, and GDPR concepts.
